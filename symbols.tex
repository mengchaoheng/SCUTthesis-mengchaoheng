...
%	 $S$-正弦函数  &  &  $C$-余弦函数\tabularnewline
	 $\bm{G}$-NED系的重力  &  &   $\varphi_0 $-气动面安装角\tabularnewline
%	 $ {\bm{I}}^{'} $-惯性张量  &  &  $ {\bm{\omega}}^{'} $-角速度矢量\tabularnewline
%	 ${\bm{L}}^{'}$-角动量  
	  $ w $-系统的外部扰动&  &  $T$-系统采样周期\tabularnewline
	 $\bm{F}$-机体系的气动力  &  &   $\bm{M}$-机体系的气动力矩\tabularnewline
%	 $\bm{F}_a$-机身空气阻力  &  &  $\bm{M}_{a}$-机身空气阻力力矩\tabularnewline
%	 $\bm{F}_{r}$-涵道内部旋翼升力  &  &  $\bm{M}_{r}$-涵道内部旋翼力矩\tabularnewline
%	 $\bm{F}_{d}$-涵道翼型力  &  &  $\bm{M}_{d}$-涵道翼型力矩\tabularnewline
%	 $\bm{F}_{c}$-涵道底部控制舵力 &  &  $\bm{M}_{c}$-涵道底部控制舵力矩\tabularnewline   
%	 $\bm{M}_{g}$-陀螺力矩  &  &  $\bm{M}_{a f}$-固定气动面扭矩\tabularnewline
...
%	   &  & \tabularnewline
%	 $ \bm{F}_{L} $-左涵道气动力  &  &  $ \bm{F}_{R} $-右涵道气动力\tabularnewline
%	 $ \bm{M}_{L} $-左涵道气动力矩  &  &  $ \bm{M}_{R} $-右涵道气动力矩\tabularnewline
%	 $ l_2 $-两个涵道的旋翼的旋转中心的距离
	 %第三章
%	   &  & \tabularnewline	  					
	\end{tabular}
